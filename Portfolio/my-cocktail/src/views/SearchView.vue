...
<script>
// @ is an alias to /src
import AppCocktail from "@/components/AppCocktail.vue";
  ...
  methods: {
    getCocktails: function () {
      if (Object.keys(this.$route.query).includes("name")) {
        CocktailApi.getCocktailsByName(this.$route.query.name)
          .then((newCocktails) => {
        ...
        let newCocktails = "";
        CocktailApi.getCocktailsByType(this.$route.query.type)
          .then((typeCocktails) => {
            CocktailApi.getCocktailsByCategory(
              this.$route.query.category
            ).then((categoryCocktails) => {
              CocktailApi.getCocktailsByIngredient(
                this.$route.query.ingredient
